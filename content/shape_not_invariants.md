...
essence: "Interchange types describe what fields exist, not which values are valid. Invariants belong to the translator and the domain type, not to the wire format."
---
