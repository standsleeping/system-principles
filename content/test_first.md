...
The conversation order matters: "What should happen?" then "How do we verify it?" then "How do we build it?" Writing the test first forces you to think about the interface before the implementation.