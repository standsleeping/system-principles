...
essence: "Shrink the representable state space to only valid states. Move Any types and try/except close to boundaries; convert to meaningful types immediately."
---
