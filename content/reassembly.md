...
If components can be recombined in new ways without modification, they're simple. If reassembly requires rewriting, they're tangled. The test: can you build something new from existing pieces?