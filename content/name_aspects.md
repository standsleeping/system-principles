...
Once named, aspects become visible. "The pricing logic" can be discussed, moved, and changed. Unnamed aspects stay hidden inside other code, silently coupling things that should be separate.