...
| [TD8](modeling.md#td8-domain-type-safety) | Domain type safety | No untyped maps in domain; use Result types. |
...
| [TP7](modeling.md#tp7-parse-into-stronger-types) | Parse into stronger types | Return proof-carrying values, not booleans. |
...
| Tag | Principle | Summary |
|-----|-----------|---------|
| [BT1](structuring.md#bt1-translator-functions) | Translator functions | Standard pattern for external-to-domain conversion. |
| [BT2](structuring.md#bt2-pure-conversion-only) | Pure conversion only | Translators convert types; no domain operations. |
...
| [T3](verifying.md#t3-declarative-test-documentation) | Declarative test documentation | Name tests as facts: "Loads env..." not "Tests that...". |
| [T4](verifying.md#t4-functional-testing-patterns) | Functional testing patterns | Input/output pairs; single assertion per test. |
...
| [MR3](verifying.md#mr3-use-purpose-built-boundary-test-doubles) | Use purpose-built boundary test doubles | Dedicated helpers for each boundary type. |
| [MR4](verifying.md#mr4-mocking-indicates-design-problems) | Mocking indicates design problems | Need to mock signals poor architectural boundaries. |
...
| **Types** | Type Design (TD), Type Patterns (TP), Data Interchange (DDI) |
